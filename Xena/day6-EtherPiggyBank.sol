...
contract EtherPiggyBank{
    ...
    function withdrawalAmount(uint256 _amount) public onlyRegisteredMember{
        require(_amount > 0, "Invalid amount");
    ...
    function getBalance(address _member) public view onlyRegisteredMember returns(uint256){
        require(_member != address(0), "Invalid address");
        require(registeredMembers[_member], "This member not registered");
