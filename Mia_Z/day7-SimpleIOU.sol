...
contract SimpleIOU{
   ...
   mapping(address => bool) public registeredFriends;
    ...
    modifier onlyRegistered(){
        ...
        require(registeredFriends[msg.sender], "You are not registered as a friend");
        _;
    }
    ...
    function recordDebt(address _debtor, uint256 _amount) public onlyRegistered{
        ...
        require(_amount>0,"Must record a positive debt");
    ...
    function payFromWallet(address _creditor, uint256 _amount) public onlyRegistered{
        ...
        require(_amount>0,"Must pay a positive amount");
        require(debts[msg.sender][_creditor] >= _amount, "Debt amount incorrest");
