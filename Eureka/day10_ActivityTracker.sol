...
contract SimpleFitnessTracker
{
    ...
    {
        WorkoutActivity memory newWorkout=WorkoutActivity({activityType:_activityType,duration:_duration,distance:_distance,timestamp:block.timestamp});
        //临时数据memory，推入数组之后是storage
