...
contract AuctionHouse {
    ...
    function bid(uint amount) external {
        ...
        //出价必须至少等于起拍价
        require(amount >= reservePrice, "Bid must be at least the reserve price.");
        //当前出价额必须高于前一次出价额
        require(amount > bids[msg.sender] * 105 / 100, "New bid must be higher than your current bid.");
        //如果出价记录等于0说明没出价过 记录出价人地址
