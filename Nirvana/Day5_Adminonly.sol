...
contract AdminOnly {
    ...
    function approveWithdrawal (address recipient, uint256 amount) public onlyOwner {
        ...
        approveWithdrawal(recipient, amount);
    }

    //Anyone can attampt to withdraw, but only those with allowance will succeed
    function withdrawTreasure(uint256 amount) public {
        ...
        require(allowance > 0, "Yon don't have any treasure allowance");
